...
public class PyPasStatementsImpl extends ASTWrapperPsiElement implements PyPasStatements {

  public PyPasStatementsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PyPasStatement> getStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PyPasStatement.class);
  }
