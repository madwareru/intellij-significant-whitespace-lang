...
public class PyPasVarDefinitionsImpl extends ASTWrapperPsiElement implements PyPasVarDefinitions {

  public PyPasVarDefinitionsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PyPasVisitor visitor) {
    visitor.visitVarDefinitions(this);
  }
