...
public class PyPasProcDefineImpl extends ASTWrapperPsiElement implements PyPasProcDefine {

  public PyPasProcDefineImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PyPasVisitor visitor) {
    visitor.visitProcDefine(this);
  }
