...
public class PyPasLogicAndExprImpl extends ASTWrapperPsiElement implements PyPasLogicAndExpr {

  public PyPasLogicAndExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PyPasLogicOrExpr> getLogicOrExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PyPasLogicOrExpr.class);
  }
