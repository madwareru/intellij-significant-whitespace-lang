...
public class PyPasLogicNotExprImpl extends ASTWrapperPsiElement implements PyPasLogicNotExpr {

  public PyPasLogicNotExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PyPasVisitor visitor) {
    visitor.visitLogicNotExpr(this);
  }
  ...
  @Override
  @NotNull
  public PyPasCompareExpr getCompareExpr() {
    return findNotNullChildByClass(PyPasCompareExpr.class);
  }
