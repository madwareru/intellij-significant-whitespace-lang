...
public class PyPasReturnStatementImpl extends ASTWrapperPsiElement implements PyPasReturnStatement {

  public PyPasReturnStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
