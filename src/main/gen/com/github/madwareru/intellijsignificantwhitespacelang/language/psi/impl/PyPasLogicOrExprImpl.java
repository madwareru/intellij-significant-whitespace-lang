...
public class PyPasLogicOrExprImpl extends ASTWrapperPsiElement implements PyPasLogicOrExpr {

  public PyPasLogicOrExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PyPasLogicNotExpr> getLogicNotExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PyPasLogicNotExpr.class);
  }
