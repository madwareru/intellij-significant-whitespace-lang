...
public class PyPasSubfieldAccessImpl extends ASTWrapperPsiElement implements PyPasSubfieldAccess {

  public PyPasSubfieldAccessImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PyPasVisitor visitor) {
    visitor.visitSubfieldAccess(this);
  }
