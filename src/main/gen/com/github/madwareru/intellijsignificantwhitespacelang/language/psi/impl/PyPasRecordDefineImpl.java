...
public class PyPasRecordDefineImpl extends ASTWrapperPsiElement implements PyPasRecordDefine {

  public PyPasRecordDefineImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PyPasVisitor visitor) {
    visitor.visitRecordDefine(this);
  }
  ...
  @Override
  @NotNull
  public PyPasRecordBody getRecordBody() {
    return findNotNullChildByClass(PyPasRecordBody.class);
  }
