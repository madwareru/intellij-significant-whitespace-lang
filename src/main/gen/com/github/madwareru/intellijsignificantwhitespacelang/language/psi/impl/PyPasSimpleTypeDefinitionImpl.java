...
public class PyPasSimpleTypeDefinitionImpl extends ASTWrapperPsiElement implements PyPasSimpleTypeDefinition {

  public PyPasSimpleTypeDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PyPasVisitor visitor) {
    visitor.visitSimpleTypeDefinition(this);
  }
