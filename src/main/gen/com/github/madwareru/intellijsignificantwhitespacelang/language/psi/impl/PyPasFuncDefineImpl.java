...
public class PyPasFuncDefineImpl extends ASTWrapperPsiElement implements PyPasFuncDefine {

  public PyPasFuncDefineImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PyPasVisitor visitor) {
    visitor.visitFuncDefine(this);
  }
  ...
  @Override
  @Nullable
  public PyPasArgDefs getArgDefs() {
    return findChildByClass(PyPasArgDefs.class);
  }
