...
public class PyPasVarDefinitionsSingleLineImpl extends ASTWrapperPsiElement implements PyPasVarDefinitionsSingleLine {

  public PyPasVarDefinitionsSingleLineImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PyPasVisitor visitor) {
    visitor.visitVarDefinitionsSingleLine(this);
  }
  ...
  @Override
  @NotNull
  public List<PyPasVarDefinition> getVarDefinitionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PyPasVarDefinition.class);
  }
