...
public class PyPasLetDefinitionsImpl extends ASTWrapperPsiElement implements PyPasLetDefinitions {

  public PyPasLetDefinitionsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PyPasVisitor visitor) {
    visitor.visitLetDefinitions(this);
  }
