...
public class PyPasArrayTypeDefinitionImpl extends ASTWrapperPsiElement implements PyPasArrayTypeDefinition {

  public PyPasArrayTypeDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
