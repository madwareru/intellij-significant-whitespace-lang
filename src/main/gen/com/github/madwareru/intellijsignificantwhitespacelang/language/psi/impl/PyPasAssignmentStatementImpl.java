...
public class PyPasAssignmentStatementImpl extends ASTWrapperPsiElement implements PyPasAssignmentStatement {

  public PyPasAssignmentStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
