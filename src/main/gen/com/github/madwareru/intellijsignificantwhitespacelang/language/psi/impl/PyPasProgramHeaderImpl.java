...
public class PyPasProgramHeaderImpl extends ASTWrapperPsiElement implements PyPasProgramHeader {

  public PyPasProgramHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PyPasVisitor visitor) {
    visitor.visitProgramHeader(this);
  }
